        ...
        return (
            ...
            >
                <Text style={{ ...Fonts.whiteRegular }}>
                    {iswatchList == false ? 'Remove from watchlist' : 'Added to watchlist'}
                </Text>
            </Snackbar>
        )
    }
                ...
                >
                    <View style={{
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => { updateState({ showBottomSheet: false }), navigation.navigate('Success') }}
                        >
            ...
            datasets: [
                {
                    ...
                    color: (opacity = 0.5) => `rgba(32, 147, 240, ${opacity})`,
                }
            ],
        };
